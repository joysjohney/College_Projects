...
{
    public partial class xbook1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if ((n1 >= 0))
            {
                Response.Write("<script>alert('Please select another date ! Team ACS')</script>");
                TextBox10.Text = "";
            }
        ...
        {
            Response.Redirect("private jet.aspx");
        }
